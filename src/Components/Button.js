...
const Button = ({title , type , icon , ButtonName = 'button' , to , ...props  }) => {
  icon = icon ? icon : Arrow;
  return (
    <ButtonName {...props} type={type} className='flex items-center gap-5 bg-[#E43D30] text-white ps-8 pe-3 py-3 rounded-full duration-300 hover:bg-[#e43c30d2] group'>
        {title}
